...
public class ParentChildDemo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Matrix4x4 parentConversionMatrix = Matrix4x4.TRS(transform.position, transform.rotation, transform.localScale);
        manualWorldPos = parentConversionMatrix.MultiplyPoint(childLocalPos);
